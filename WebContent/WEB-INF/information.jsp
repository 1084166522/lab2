...
<html>
	...
	<body style="text-align:center">
		...
		<a href=Search?username=<%out.print(list0.get(1)); %>><button type="button" style="text-align:center">返回</button></a>
		<a href=Login><button type="button" style="text-align:center">返回主页</button></a>
	</body>
</html>